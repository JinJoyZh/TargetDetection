...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=None, dnn=False, data=None):
        ...
        self.pt, self.jit, self.onnx, self.xml, self.engine, self.coreml, self.saved_model, self.pb, self.tflite, self.edgetpu, self.tfjs = self.model_type(w)  # get backend
        ...
        if self.pt:  # PyTorch
            ...
            if extra_files['config.txt']:
                ...
                self.stride, names = int(d['stride']), d['names']
            ...
            if self.saved_model:  # SavedModel
            ...
            elif self.pb:  # GraphDef https://www.tensorflow.org/guide/migrate#a_graphpb_or_graphpbtxt
                ...
                self.frozen_func = wrap_frozen_graph(gd, inputs="x:0", outputs="Identity:0")
            elif self.tflite or self.edgetpu:  # https://www.tensorflow.org/lite/guide/python#install_tensorflow_lite_for_python
                try:  # https://coral.ai/docs/edgetpu/tflite-python/#update-existing-tf-lite-code-for-the-edge-tpu
                    from tflite_runtime.interpreter import Interpreter, load_delegate
                except ImportError:
                    import tensorflow as tf
                    Interpreter, load_delegate = tf.lite.Interpreter, tf.lite.experimental.load_delegate,
                if self.edgetpu:  # Edge TPU https://coral.ai/software/#edgetpu-runtime
