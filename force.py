...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='data/train_img')
    parser.add_argument('--source_xml_path', type=str, default='data/train_xml')
